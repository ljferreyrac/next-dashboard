...
export async function generateStaticParams(){
  ...
  const pokemon: PokemonsResponse = await fetch('https://pokeapi.co/api/v2/pokemon?limit=151')
            .then(resp => resp.json());
...
export async function generateMetadata({params}: Props): Promise<Metadata>{
    try {
        ...
        return {
            ...
            description: 'Irure nisi incididunt fugiat pariatur nisi cillum qui occaecat dolore sit eu excepteur ut aute.'
        }
    }
}
